...
}`,...(Ue=(Ae=E.parameters)==null?void 0:Ae.docs)==null?void 0:Ue.source}}};var We,ye,Re;z.parameters={...z.parameters,docs:{...(We=z.parameters)==null?void 0:We.docs,source:{originalSource:`{
  render: () => {
    const stepToProps: Record<string, any> = {
      default: {
        text: "JPG, PNG or GIF - Max file size 2MB"
...
}`,...(Re=(ye=z.parameters)==null?void 0:ye.docs)==null?void 0:Re.source}}};var Ce,Ve,Ke;J.parameters={...J.parameters,docs:{...(Ce=J.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  render: () => {
    const ref = useRef<FileUploaderRefType>(null);
    const [value, setValue] = useState<File[]>([]);
    return <div>
