import{j as s}from"./jsx-runtime-CLpGMVip.js";import{t as a}from"./cunningham-tokens-Bq47iuNG.js";const u={title:"Misc/Spacings"},n={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.theme.font.sizes).map(e=>s.jsxs("div",{className:"clr-greyscale-800 fs-"+e,children:["Using the ",s.jsxs("code",{children:["fs-",e]})," class"]},e))})},r={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.theme.font.weights).map(e=>s.jsxs("div",{className:"clr-greyscale-800 fs-l fw-"+e,children:["Using the ",s.jsxs("code",{children:["fw-",e]})," class"]},e))})},t={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:Object.keys(a.themes.default.theme.font.families).map(e=>s.jsxs("div",{className:"clr-greyscale-800 f-"+e,children:["Using the ",s.jsxs("code",{children:["f-",e]})," class"]},e))})};var c,l,i;n.parameters={...n.parameters,docs:{...(c=n.parameters)==null?void 0:c.docs,source:{originalSource:`{
  render: () => {
    return <div style={{
      display: "flex",
