...
| "tertiary"
| "tertiary-text"
| "danger"`,elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"primary-text"'},{name:"literal",value:'"secondary"'},{name:"literal",value:'"tertiary"'},{name:"literal",value:'"tertiary-text"'},{name:"literal",value:'"danger"'}],required:!1}},{key:"icon",value:{name:"ReactNode",required:!1}},{key:"iconPosition",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!1}},{key:"active",value:{name:"boolean",required:!1}},{key:"fullWidth",value:{name:"boolean",required:!1}}]}}]},description:""},disableAnimate:{required:!1,tsType:{name:"boolean"},description:""},actions:{required:!1,tsType:{name:"ReactNode"},description:""}},composes:["PropsWithChildren"]};b.__docgenInfo={description:"",methods:[],displayName:"ProgressBar",props:{duration:{required:!0,tsType:{name:"number"},description:""}}};class M{push(t){const a=async()=>(this.lastJob&&await this.lastJob,t());return this.lastJob=a(),this.lastJob}}const w=m.createContext(void 0),I=()=>{const e=r.useContext(w);if(e===void 0)throw new Error("useToastProvider must be used within a ToastProvider.");return e};let y=1;const R=6e3,h=()=>parseInt(P.themes.default.components.toast["slide-in-duration"].replace("ms",""),10),k=({children:e})=>{const t=r.useRef(null),a=r.useRef(0),[l,o]=m.useState([]),d=r.useRef(new M),c=r.useMemo(()=>({toast:(i,u=T.NEUTRAL,s={})=>{var p;(p=d.current)==null||p.push(()=>new Promise(x=>{const A=y;y+=1,a.current=t.current.offsetHeight,o(q=>[...q,{...s,message:i,i:A,type:u,duration:(s==null?void 0:s.duration)??R}]),setTimeout(()=>{x()},h())}))}}),[t,a,l]),f=async()=>{if(!t.current)return;const i=a.current,s=t.current.offsetHeight-i;typeof t.current.animate=="function"&&!v()&&t.current.animate([{transform:`translateY(${s}px)`},{transform:"translateY(0)"}],{duration:h(),easing:"ease"})};return m.useEffect(()=>{f()},[y]),n.jsxs(w.Provider,{value:c,children:[e,n.jsx("div",{className:"c__toast__container",ref:t,children:l.map(i=>n.jsx(g,{onDelete:()=>{o(u=>u.filter(s=>s.i!==i.i))},...i,children:i.message},i.i))})]})};k.__docgenInfo={description:"",methods:[],displayName:"ToastProvider"};export{b as P,g as T,T as V,k as a,O as c,H as i,I as u};
