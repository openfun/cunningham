...
| "tertiary"
| "tertiary-text"
| "danger"`,elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"primary-text"'},{name:"literal",value:'"secondary"'},{name:"literal",value:'"tertiary"'},{name:"literal",value:'"tertiary-text"'},{name:"literal",value:'"danger"'}],required:!1}},{key:"icon",value:{name:"ReactNode",required:!1}},{key:"iconPosition",value:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}],required:!1}},{key:"active",value:{name:"boolean",required:!1}},{key:"fullWidth",value:{name:"boolean",required:!1}}]}}]},description:""},disableAnimate:{required:!1,tsType:{name:"boolean"},description:""},actions:{required:!1,tsType:{name:"ReactNode"},description:""}},composes:["PropsWithChildren"]};w.__docgenInfo={description:"",methods:[],displayName:"ProgressBar",props:{duration:{required:!0,tsType:{name:"number"},description:""}}};class N{push(t){const a=async()=>(this.lastJob&&await this.lastJob,t());return this.lastJob=a(),this.lastJob}}const A=m.createContext(void 0),I=()=>{const e=r.useContext(A);if(e===void 0)throw new Error("useToastProvider must be used within a ToastProvider.");return e};let y=1;const R=6e3,h=()=>parseInt(M.themes.default.components.toast["slide-in-duration"].replace("ms",""),10),P=({children:e})=>{const t=r.useRef(null),a=r.useRef(0),[l,o]=m.useState([]),d=r.useRef(new N),c=r.useMemo(()=>({toast:(i,u=v.NEUTRAL,s={})=>{var p;(p=d.current)==null||p.push(()=>new Promise(_=>{const x=y;y+=1,a.current=t.current.offsetHeight,o(L=>[...L,{...s,message:i,i:x,type:u,duration:(s==null?void 0:s.duration)??R}]),setTimeout(()=>{_()},h())}))}}),[t,a,l]),f=async()=>{if(!t.current)return;const i=a.current,s=t.current.offsetHeight-i;typeof t.current.animate=="function"&&!T()&&t.current.animate([{transform:`translateY(${s}px)`},{transform:"translateY(0)"}],{duration:h(),easing:"ease"})};return m.useEffect(()=>{f()},[y]),n.jsxs(A.Provider,{value:c,children:[e,n.jsx("div",{className:"c__toast__container",ref:t,children:l.map(i=>n.jsx(b,{onDelete:()=>{o(u=>u.filter(s=>s.i!==i.i))},...i,children:i.message},i.i))})]})};P.__docgenInfo={description:"",methods:[],displayName:"ToastProvider"};export{w as P,b as T,v as V,P as a,O as c,q as i,I as u};
