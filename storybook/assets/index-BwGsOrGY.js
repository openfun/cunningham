import{j as r}from"./jsx-runtime-D_zvdyIk.js";import{e as T,r as m}from"./index-DTOEHpHZ.js";import{c as f}from"./index-rkLeB0kx.js";import{u as I}from"./index-5BDOH_ZR.js";import{F as W}from"./index-D7DNl-ap.js";import{L}from"./index-3i_lEcpX.js";import{B as N}from"./index-D-xH11C0.js";import{$ as G}from"./useOverlayPosition-D2IOtbx_.js";import{u as q,a as w,b as k}from"./downshift.esm-BR_ccwds.js";import{C as Q}from"./index-B7qWtOxe.js";const x=n=>n.render!==void 0,P=({option:n,showLabelWhenSelected:e=!0})=>n?x(n)&&!e?n.render():r.jsx("span",{children:n.label}):null;P.__docgenInfo={description:"",methods:[],displayName:"SelectedOption",props:{option:{required:!0,tsType:{name:"union",raw:"Option | undefined | null",elements:[{name:"union",raw:"OptionWithoutRender | OptionWithRender",elements:[{name:"intersection",raw:`Omit<BaseOption, "value" | "render"> & {
  value?: string;
  render?: undefined;
...
| SelectMultiAuxProps["downshiftReturn"]`,elements:[{name:'SelectAuxProps["downshiftReturn"]',raw:'SelectAuxProps["downshiftReturn"]'},{name:'SelectMultiAuxProps["downshiftReturn"]',raw:'SelectMultiAuxProps["downshiftReturn"]'}]},description:""}},composes:["PropsWithChildren"]};function D(n){return e=>{var a;return!n||e.label.toLowerCase().includes(n.toLowerCase())||((a=e.value)==null?void 0:a.toLowerCase().includes(n.toLowerCase()))}}const j=n=>n?n.label:"",p=n=>n.value??n.label,S=(n,e)=>p(n)===p(e),C=n=>x(n)?n.render():n.label,M=({children:n,state:e="default",options:a,name:u,label:s,hideLabel:d,labelAsPlaceholder:l,downshiftProps:i,downshiftReturn:t,value:v,disabled:y,clearable:o=!0,onBlur:_,...O})=>{const{t:c}=I(),h=t.getLabelProps(),b=m.useRef(null);return r.jsxs(r.Fragment,{children:[r.jsx(W,{state:e,...O,children:r.jsx("div",{ref:b,className:f("c__select","c__select--mono","c__select--"+e,{"c__select--disabled":y}),onBlur:()=>{var g;return _==null?void 0:_({target:{value:(g=t.selectedItem)==null?void 0:g.value}})},children:r.jsxs("div",{className:f("c__select__wrapper",{"c__select__wrapper--focus":t.isOpen&&!y}),...t.wrapperProps,children:[t.selectedItem&&r.jsx("input",{type:"hidden",name:u,value:p(t.selectedItem)}),r.jsx(L,{label:s,hideLabel:d,labelAsPlaceholder:l,htmlFor:h.htmlFor,labelId:h.id,disabled:y,children:r.jsxs("div",{className:"c__select__inner",children:[r.jsx("div",{className:"c__select__inner__value",children:n}),r.jsxs("div",{className:"c__select__inner__actions",children:[o&&!y&&t.selectedItem&&r.jsxs(r.Fragment,{children:[r.jsx(N,{color:"tertiary-text",size:"nano","aria-label":c("components.forms.select.clear_button_aria_label"),className:"c__select__inner__actions__clear",onClick:g=>{t.selectItem(null),g.stopPropagation()},icon:r.jsx("span",{className:"material-icons",children:"close"}),type:"button"}),r.jsx("div",{className:"c__select__inner__actions__separator"})]}),r.jsx(N,{color:"tertiary-text",size:"nano",className:"c__select__inner__actions__open",icon:r.jsx("span",{className:f("material-icons",{opened:t.isOpen}),children:"arrow_drop_down"}),disabled:y,type:"button",...t.toggleButtonProps})]})]})})]})})}),r.jsx(B,{isOpen:t.isOpen,selectRef:b,downshiftReturn:t,children:r.jsxs("ul",{children:[a.map((g,R)=>{const Y=R===t.highlightedIndex;return r.jsx("li",{className:f("c__select__menu__item",{"c__select__menu__item--highlight":Y,"c__select__menu__item--selected":t.selectedItem&&S(t.selectedItem,g),"c__select__menu__item--disabled":g.disabled}),...t.getItemProps({item:g,index:R}),children:r.jsx("span",{children:C(g)})},`${p(g)}${R.toString()}`)}),a.length===0&&r.jsx("li",{className:"c__select__menu__item c__select__menu__empty-placeholder",children:c("components.forms.select.menu_empty_placeholder")})]})})]})};M.__docgenInfo={description:`This component is used by searchable and non-searchable select components.
It contains the common logic between the two.`,methods:[],displayName:"SelectMonoAux",props:{state:{required:!1,tsType:{name:"union",raw:"FieldState | undefined",elements:[{name:"union",raw:'"success" | "error" | "default"',elements:[{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"default"'}]},{name:"undefined"}]},description:"",defaultValue:{value:'"default"',computed:!1}},text:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},textItems:{required:!1,tsType:{name:"union",raw:"string[] | undefined",elements:[{name:"Array",elements:[{name:"string"}],raw:"string[]"},{name:"undefined"}]},description:""},rightText:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},fullWidth:{required:!1,tsType:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}]},description:""},compact:{required:!1,tsType:{name:"union",raw:"boolean | undefined",elements:[{name:"boolean"},{name:"undefined"}]},description:""},className:{required:!1,tsType:{name:"union",raw:"string | undefined",elements:[{name:"string"},{name:"undefined"}]},description:""},label:{required:!0,tsType:{name:"string"},description:""},hideLabel:{required:!1,tsType:{name:"boolean"},description:""},options:{required:!0,tsType:{name:"Array",elements:[{name:"union",raw:"OptionWithoutRender | OptionWithRender",elements:[{name:"intersection",raw:`Omit<BaseOption, "value" | "render"> & {
  ...
  highlightedIndex: number;
  wrapperProps?: HTMLAttributes<HTMLDivElement>;
}`,signature:{properties:[{key:"isOpen",value:{name:"boolean",required:!0}},{key:"getLabelProps",value:{name:"any",required:!0}},{key:"toggleButtonProps",value:{name:"any",required:!0}},{key:"getMenuProps",value:{name:"any",required:!0}},{key:"getItemProps",value:{name:"any",required:!0}},{key:"highlightedIndex",value:{name:"number",required:!0}},{key:"wrapperProps",value:{name:"HTMLAttributes",elements:[{name:"HTMLDivElement"}],raw:"HTMLAttributes<HTMLDivElement>",required:!1}}]}},description:""},useMultipleSelectionReturn:{required:!0,tsType:{name:"ReturnType",elements:[{name:"useMultipleSelection"}],raw:"ReturnType<typeof useMultipleSelection<Option>>"},description:""}}};const F=({ref:n,...e})=>{const[a,u]=T.useState(),s=m.useRef(null),d=T.useMemo(()=>e.options.filter(V(e.selectedItems,a)),[e.selectedItems,a]),[l,i]=m.useState(!1),t=q({selectedItems:e.selectedItems,onStateChange({selectedItems:c,type:h}){switch(h){case q.stateChangeTypes.SelectedItemKeyDownBackspace:case q.stateChangeTypes.SelectedItemKeyDownDelete:case q.stateChangeTypes.DropdownKeyDownBackspace:case q.stateChangeTypes.FunctionRemoveSelectedItem:e.onSelectedItemsChange(c??[]);break}}}),v=w({items:d,itemToString:j,defaultHighlightedIndex:0,selectedItem:null,stateReducer:(c,h)=>{const{changes:b,type:g}=h;switch(g){case w.stateChangeTypes.InputKeyDownEnter:case w.stateChangeTypes.ItemClick:return{...b,isOpen:!0,highlightedIndex:0};default:return b}},onStateChange:({inputValue:c,type:h,selectedItem:b})=>{switch(h){case w.stateChangeTypes.InputKeyDownEnter:case w.stateChangeTypes.ItemClick:case w.stateChangeTypes.InputBlur:b&&!b.disabled&&(e.onSelectedItemsChange([...e.selectedItems,b]),u(void 0));break;case w.stateChangeTypes.InputChange:u(c);break}},isItemDisabled:c=>!!c.disabled}),y=v.getInputProps({...t.getDropdownProps({preventKeyAction:v.isOpen,ref:s,disabled:e.disabled}),value:a}),{onKeyDown:o}=y;y.onKeyDown=c=>{switch(c.code){case"Backspace":a||e.onSelectedItemsChange(e.selectedItems.slice(0,-1))}o==null||o(c)};const[_,O]=m.useState(!0);return m.useEffect(()=>{if(l||a){O(!1);return}O(e.selectedItems.length===0)},[e.selectedItems,l,a]),m.useImperativeHandle(n,()=>({blur:()=>{var c;v.closeMenu(),(c=s.current)==null||c.blur()}})),m.useEffect(()=>{var c;(c=e.onSearchInputChange)==null||c.call(e,{target:{value:a}})},[a]),r.jsx(A,{...e,monoline:!1,options:d,labelAsPlaceholder:_,selectedItems:e.selectedItems,downshiftReturn:{...v,wrapperProps:{onClick:()=>{var c;(c=s.current)==null||c.focus(),v.isOpen||v.openMenu()}},toggleButtonProps:v.getToggleButtonProps()},useMultipleSelectionReturn:t,children:r.jsx("span",{className:"c__select__inner__value__input","data-value":a,children:r.jsx("input",{...y,onFocus:()=>{i(!0),v.openMenu()},onBlur:()=>{i(!1)},size:4})})})};F.__docgenInfo={description:"",methods:[{name:"blur",docblock:null,modifiers:[],params:[],returns:null}],displayName:"SelectMultiSearchable",props:{onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(event: { target: { value: string[] } }) => void",signature:{arguments:[{type:{name:"signature",type:"object",raw:"{ target: { value: string[] } }",signature:{properties:[{key:"target",value:{name:"signature",type:"object",raw:"{ value: string[] }",signature:{properties:[{key:"value",value:{name:"Array",elements:[{name:"string"}],raw:"string[]",required:!0}}]},required:!0}}]}},name:"event"}],return:{name:"void"}}},description:""},onSelectedItemsChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(selectedItems: Option[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"union",raw:"OptionWithoutRender | OptionWithRender",elements:[{name:"intersection",raw:`Omit<BaseOption, "value" | "render"> & {
  value?: string;
  render?: undefined;
}`,elements:[{name:"Omit",elements:[{name:"signature",type:"object",raw:`{
  value: string;
