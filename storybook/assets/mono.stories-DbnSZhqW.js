import{j as e}from"./jsx-runtime-X2b_N9AH.js";import{r as v}from"./index-uCp2LrAq.js";import{c as na,e as la,u as ta,F as ra,o as sa,d as oa}from"./reactHookFormUtils-D8f2boA3.js";import{S as r}from"./index-CRKWOKCm.js";import{B as s}from"./index-D295LG-j.js";import{g as i,R as ia}from"./stories-utils-CjRR0d7y.js";import{a as ca,M as ua,b as da}from"./index-nUFazOPM.js";import{I as y}from"./index-CFk9Hz-J.js";const ma={title:"Components/Forms/Select/Mono",component:r},t=n=>e.jsx("div",{style:{paddingBottom:"200px",position:"relative"},children:e.jsx(r,{...n})}),pa=["Woodbury","Port Gayle","Geovannichester","San Rafael","Conradchester","Geraldinehaven","Bofield","East Ansel","New Carlo","West Minnieborough"],a=pa.map(n=>({label:n,value:n.toLowerCase()})),f={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value}},O={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value,disabled:!0}},x={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value,text:"This is a text, you can display anything you want here like warnings, information or errors."}},T={render:t,args:{label:"Select a city",hideLabel:!0,options:a,defaultValue:a[4].value}},u=()=>{const[n,l]=v.useState(a[8].value);return e.jsxs("div",{children:[e.jsxs("div",{children:["Value: ",e.jsx("span",{children:n})]}),e.jsx(r,{label:"Select a city",options:a,value:n,onChange:o=>{l(o.target.value)}}),e.jsx(s,{onClick:()=>l(""),children:"Reset"}),e.jsxs(s,{onClick:()=>l(a[0].value),children:["Set ",a[0].label]}),e.jsxs(s,{onClick:()=>l(a[1].value),children:["Set ",a[1].label]})]})},d=()=>{const[n,l]=v.useState(a[0].value),[o,c]=v.useState(a),ea=()=>{c([{value:"woodbury",label:"EDITTED"},...a.slice(1)])};return e.jsxs("div",{children:[e.jsxs("div",{children:["Value: ",e.jsx("span",{children:n}),e.jsx(s,{onClick:ea,children:"Edit"})]}),e.jsx(r,{label:"Select a city",options:o,value:n,multi:!1,searchable:!0,onChange:aa=>{l(aa.target.value)}}),e.jsx(s,{onClick:()=>l(""),children:"Reset"})]})},N={render:t,args:{label:"Select a city",options:[{value:"1",label:"Very long long long long long long long city name"}],defaultValue:"1"}},C={render:t,args:{label:"Select a city",options:a,searchable:!0}},j={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value,searchable:!0}},I={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value,searchable:!0,disabled:!0}},m=()=>{const[n,l]=v.useState(a[8].value);return e.jsxs("div",{children:[e.jsxs("div",{children:["Value: ",e.jsx("span",{children:n})]}),e.jsx(r,{label:"Select a city",options:a,searchable:!0,value:n,onChange:o=>{l(o.target.value)}}),e.jsx(s,{onClick:()=>l(""),children:"Reset"}),e.jsxs(s,{onClick:()=>l(a[0].value),children:["Set ",a[0].label]}),e.jsxs(s,{onClick:()=>l(a[1].value),children:["Set ",a[1].label]})]})},P={render:t,args:{label:"Select a city",options:a,fullWidth:!0}},E={render:t,args:{label:"Select a city",options:a,defaultValue:a[4].value,clearable:!1}},V={render:t,args:{label:"Select a city",options:a.map((n,l)=>({...n,disabled:l%3===0}))}},w={render:t,args:{label:"Select a city",options:a,state:"success",text:"Well done"}},k={render:t,args:{label:"Select a city",options:a,state:"error",text:"Something went wrong"}},R={render:t,args:{label:"No options available",options:[]}},F={render:t,args:{label:"Select a country",showLabelWhenSelected:!1,options:[i("Germany","DE"),i("France","FR"),i("United States","US"),i("Spain","ES"),i("China","CN")],defaultValue:"france"}},B={render:t,args:{label:"Select a country",showLabelWhenSelected:!1,searchable:!0,options:[i("Germany","DE"),i("France","FR"),i("United States","US"),i("Spain","ES"),i("China","CN")]}},p=()=>{const n=v.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"pb-s",children:e.jsx(s,{onClick:()=>setTimeout(()=>{var l;console.log("calling blur() ..."),(l=n.current)==null||l.blur()},2e3),children:"Trigger onBlur in 2 seconds"})}),e.jsx(r,{label:"Select a city",options:a,ref:n})]})},b=()=>{const n=v.useRef(null);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"pb-s",children:e.jsx(s,{onClick:()=>setTimeout(()=>{var l;console.log("calling blur() ..."),(l=n.current)==null||l.blur()},2e3),children:"Trigger onBlur in 2 seconds"})}),e.jsx(r,{label:"Select a city",options:a,searchable:!0,ref:n})]})},S=()=>{const n=l=>{l.preventDefault();const o=new FormData(l.target);console.log(o.getAll("city"))};return e.jsxs("form",{onSubmit:n,children:[e.jsx("div",{className:"mb-s",children:e.jsx(r,{label:"Your city",name:"city",options:a,defaultValue:a[2].value,text:"The city you were born in",state:"success"})}),e.jsx("div",{className:"mb-s",children:e.jsx(r,{label:"Your gender",name:"gender",options:[{label:"Male"},{label:"Female"},{label:"Other"}]})}),e.jsx("div",{className:"mb-s",children:e.jsx(r,{label:"Your department",name:"department",searchable:!0,options:[{label:"Legal"},{label:"Tech"},{label:"AI"},{label:"Accounting"}]})}),e.jsx("div",{className:"mb-s",children:e.jsx(r,{label:"Your grade",text:"Any error you want",name:"grade",searchable:!0,options:[{label:"Level 1"},{label:"Level 2"},{label:"Level 3"},{label:"Emperor"}],state:"error"})}),e.jsx("div",{className:"mb-s",children:e.jsx(r,{label:"Your plan",text:"This field is disabled",name:"grade",disabled:!0,options:[{label:"Bronze"},{label:"Silver"},{label:"Gold"},{label:"Platinum"}],defaultValue:"Platinum"})}),e.jsx(s,{children:"Submit"})]})},h=()=>{const n=ca({isOpenDefault:!0});return e.jsx(ua,{size:da.MEDIUM,...n,title:"Example",children:e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"1rem"},children:[e.jsx(r,{label:"Context",options:[{label:"Ask a document"},{label:"Download files"},{label:"Ask for help"}],fullWidth:!0,clearable:!0}),e.jsxs("div",{style:{display:"flex",gap:"1rem"},children:[e.jsx(y,{label:"First name"}),e.jsx(y,{label:"Last name"})]}),e.jsx(y,{label:"Email address",fullWidth:!0,text:"Only @acme.com domain is authorized"}),e.jsxs("div",{style:{display:"flex",gap:"1rem"},children:[e.jsx("div",{style:{width:"25%"},children:e.jsx(y,{label:"ZIP",fullWidth:!0})}),e.jsx(y,{label:"City",fullWidth:!0})]}),e.jsx(r,{label:"Skills",options:[{label:"Communication"},{label:"Teamwork"},{label:"Problem solving"},{label:"Leadership"},{label:"Work ethic"}],fullWidth:!0})]})})},g=()=>{let n;(c=>{c.NONE="",c.DIJON="dijon",c.PARIS="paris",c.TOKYO="tokyo"})(n||(n={}));const l=na().shape({joTown:la().required().oneOf(["paris"],"That's not the right town!")}),o=ta({defaultValues:{joTown:""},mode:"onChange",reValidateMode:"onChange",resolver:oa(l)});return e.jsx(ra,{...o,children:e.jsxs("form",{style:{display:"flex",flexDirection:"column",gap:"1rem",width:"400px"},onSubmit:o.handleSubmit(sa),children:[e.jsx("div",{className:"clr-greyscale-900",children:"Where will the 2024 Olympics take place?"}),e.jsx(ia,{name:"joTown",label:"Select a city",fullWidth:!0,options:[{label:"Dijon",value:"dijon"},{label:"Paris",value:"paris"},{label:"Tokyo",value:"tokyo"}]}),e.jsx(s,{fullWidth:!0,children:"Submit"})]})})};u.__docgenInfo={description:"",methods:[],displayName:"Controlled"};d.__docgenInfo={description:"",methods:[],displayName:"ControlledEdit"};m.__docgenInfo={description:"",methods:[],displayName:"SearchableControlled"};p.__docgenInfo={description:"",methods:[],displayName:"Ref"};b.__docgenInfo={description:"",methods:[],displayName:"SearchableRef"};S.__docgenInfo={description:"",methods:[],displayName:"FormExample"};h.__docgenInfo={description:"",methods:[],displayName:"SelectInModal"};g.__docgenInfo={description:"",methods:[],displayName:"ReactHookForm"};var D,W,_;f.parameters={...f.parameters,docs:{...(D=f.parameters)==null?void 0:D.docs,source:{originalSource:`{
  render: Template,
  args: {
    label: "Select a city",
    options: OPTIONS,
...
}`,...(X=(Q=d.parameters)==null?void 0:Q.docs)==null?void 0:X.source}}};var ee,ae,ne;N.parameters={...N.parameters,docs:{...(ee=N.parameters)==null?void 0:ee.docs,source:{originalSource:`{
  render: Template,
  args: {
    label: "Select a city",
    options: [{
...
}`,...(ne=(ae=N.parameters)==null?void 0:ae.docs)==null?void 0:ne.source}}};var le,te,re;C.parameters={...C.parameters,docs:{...(le=C.parameters)==null?void 0:le.docs,source:{originalSource:`{
  render: Template,
  args: {
    label: "Select a city",
    options: OPTIONS,
